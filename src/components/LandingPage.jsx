...
import bgImage from '../assets/Landing Page Background 3 - Lumino.jpg'
    ...
    <>
      ...
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
        ...
        <div className="nav-right-group">
          ...
          {/* CATEGORY DROPDOWN → REDIRECT TO AUTH */}
          <div
          ...
          >
            ...
            <div className={`dropdown-menu ${categoryOpen ? "open" : ""}`}>
              <div className="dropdown-inner">
                <a onClick={() => navigate("/auth")}>🎬 Movies</a>
                <a onClick={() => navigate("/auth")}>🎤 Standup Comedy</a>
                <a onClick={() => navigate("/auth")}>🎵 Concerts</a>
                <a onClick={() => navigate("/auth")}>🎭 Theatre & Acting</a>
              </div>
            </div>
          </div>

          {/* CITY DROPDOWN REMOVED COMPLETELY */}
      ...
      <main className="main-content">
        <div className="main-top">
          ...
          <p>
            From underground jazz sets to rooftop raves — Lumino surfaces every live experience happening near you, before it sells out.
          </p>
        </div>
